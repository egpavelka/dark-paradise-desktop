...
;;;;; org
     ...
     `(org-level-1 ((,class (:inherit nil :family ,et-font :slant italic :height 1.6))))
     `(org-level-2 ((,class (:inherit nil :family ,et-font))))
     `(org-level-3 ((,class (:inherit nil :family ,et-font))))
     `(org-level-4 ((,class (:inherit nil :family ,et-font))))
     `(org-level-5 ((,class (:inherit nil :family ,et-font))))
     `(org-level-6 ((,class (:inherit nil :family ,et-font))))
     `(org-level-7 ((,class (:inherit nil :family ,et-font))))
     `(org-level-8 ((,class (:inherit nil :family ,et-font))))
