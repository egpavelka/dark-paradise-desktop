;;; spacemacs-dark-paradise-theme.el --- Custom version of spacemacs light theme to match desktop theme
...
(let ((class '((class color) (min-colors 89)))
   ...
   (bg1             "#091f2c")
   (bg2             "#203a3e")(cblk-bg "#203a3e")(ttip-bg "#203a3e")(comment-bg "georgia#203a3e")
...
;;;;; basics
     ...
     `(page-break-lines ((,class (:foreground ,border))))
...
;;;;; org
     ...
     `(org-document-info-keyword ((,class (:foreground ,comment :height 0.8))))
     ...
     `(org-level-1 ((,class (:inherit nil :family ,et-font :slant italic :height 1.5))))
     `(org-level-2 ((,class (:inherit nil :family ,et-font :height 1.3))))
     `(org-level-3 ((,class (:inherit nil :family ,et-font :height 1.3))))
     `(org-level-4 ((,class (:inherit nil :family ,et-font :height 1.3))))
     `(org-level-5 ((,class (:inherit nil :family ,et-font :height 1.3))))
     `(org-level-6 ((,class (:inherit nil :family ,et-font :height 1.3))))
     `(org-level-7 ((,class (:inherit nil :family ,et-font :height 1.3))))
     `(org-level-8 ((,class (:inherit nil :family ,et-font :height 1.3))))
     ...
     `(org-todo ((,class (:foreground ,type :inherit bold :height 1.5 :background nil))))
